...
logger = get_logger('neofish.simulation_runner')
...
class SimulationRunner:
    ...
    _run_state_snapshots: Dict[str, str] = {}
    ...
    def _load_run_state(cls, simulation_id: str) -> Optional[SimulationRunState]:
        ...
        try:
            ...
            cls._run_state_snapshots[simulation_id] = cls._serialize_run_state_data(data)
            return state
    ...
    @classmethod
    def _serialize_run_state_data(cls, data: Dict[str, Any]) -> str:
    ...
    def _save_run_state(cls, state: SimulationRunState):
        ...
        serialized = cls._serialize_run_state_data(data)
        previous = cls._run_state_snapshots.get(state.simulation_id)
        ...
        cls._run_state_snapshots[state.simulation_id] = serialized
        cls._run_states[state.simulation_id] = state
    ...
    def start_simulation(
        ...
        enable_graph_memory_update: bool = False,  # Neo4j SimEpisode 메모리
        graph_id: str = None  # Neo4j graph_id
    ) -> SimulationRunState:
        """
        시작시뮬레이션
        ...
        Args:
            ...
            enable_graph_memory_update: 시뮬 액션을 Neo4j 그래프 메모리에 반영
    ...
    def cleanup_simulation_logs(cls, simulation_id: str) -> Dict[str, Any]:
        ...
        cls._run_state_snapshots.pop(simulation_id, None)
