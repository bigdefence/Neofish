  ...
  "entity_types": [
    {
      ...
      "attributes": [
        ...
        },
        {
          ...
          "type": "text",
          "description": "인격적 특성, MBTI, 가치관 등 심리적 배경"
        },
        {
          "name": "cognitive_biases",
          "type": "text",
          "description": "확증 편향, FOMO, 손실 회피 등 이 엔터티가 취약한 인지 편향 목록"
        }
      ],
...
class OntologyGenerator:
    ...
    def __init__(self, llm_client: Optional[LLMClient] = None):
        self.llm_client = llm_client or LLMClient(model=Config.LLM_REASONING_MODEL_NAME)
...
"""
    ...
    def _validate_and_process(self, result: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # 온톨로지 타입 수 상한(엔터티/엣지 타입 각각 최대 10개)
        MAX_ENTITY_TYPES = 10
        MAX_EDGE_TYPES = 10
        ...
        person_fallback = {
            ...
            "attributes": [
                ...
                {"name": "psychological_profile", "type": "text", "description": "Personality traits, MBTI, values, etc."},
                {"name": "cognitive_biases", "type": "text", "description": "List of cognitive biases this person is prone to (e.g., confirmation bias, FOMO)"}
            ],
        ...
        organization_fallback = {
            ...
            "attributes": [
                ...
                {"name": "institutional_psychology", "type": "text", "description": "Corporate culture, institutional goals, risk tolerance"},
                {"name": "biases", "type": "text", "description": "Groupthink, sunk cost fallacy, or other institutional biases"}
            ],
    ...
    def generate_python_code(self, ontology: Dict[str, Any]) -> str:
        ...
        code_lines = [
            ...
            'Auto-generated by Neofish for social opinion simulation',
            '"""',
            '',
